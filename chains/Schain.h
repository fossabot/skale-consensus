...
class BlockRetrieverAgent;

class BlockProposalPusherAgent;

class BlockProposalPusherThreadPool;

class SubChainProtocolInstance;
...
private:
    ...
    ptr<BlockProposalPusherAgent> blockProposalClient;

    ptr<BlockRetrieverAgent> blockRetrieverAgent;
...
public:
    ...
    const ptr<ReceivedBlockProposalsDatabase> &getBlockProposalsDatabase() const;
